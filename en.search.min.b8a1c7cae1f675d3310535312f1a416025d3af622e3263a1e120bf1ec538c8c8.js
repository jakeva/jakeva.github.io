...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.88136380f3a59d5646328f42013596135e110200986a5df240ce3e66de199b35.js',function(){input.required=false;search();});}
