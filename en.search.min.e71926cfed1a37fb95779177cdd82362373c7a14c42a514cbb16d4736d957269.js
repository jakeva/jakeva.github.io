...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d36973e00cbf6b250779980ea9a12da469434c75a83299a296865747fb9a7b97.js',function(){input.required=false;search();});}
