...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9025c283d754476644fcf86e581404655565af6ca23a58073ff9890b43ed84dc.js',function(){input.required=false;search();});}
